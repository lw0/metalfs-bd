...
entity bf_keyInit_c_initbkb_rom is 
    generic(
             dwidth     : integer := 32; 
             awidth     : integer := 5; 
             mem_size    : integer := 18
...
architecture rtl of bf_keyInit_c_initbkb_rom is 
...
entity bf_keyInit_c_initbkb is
    generic (
...
architecture arch of bf_keyInit_c_initbkb is
    component bf_keyInit_c_initbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    bf_keyInit_c_initbkb_rom_U :  component bf_keyInit_c_initbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
